...
Web::DOM::HTMLDListElement - The DOM |HTMLDListElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLDListElement> class implements the DOM
C<HTMLDListElement> interface.  The class is used by the HTML C<dl>
element.
