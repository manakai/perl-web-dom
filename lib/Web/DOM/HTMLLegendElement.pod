...
Web::DOM::HTMLLegendElement - The DOM |HTMLLegendElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLLegendElement> class implements the DOM
C<HTMLLegendElement> interface.  The class is used by the HTML
C<legend> element.
