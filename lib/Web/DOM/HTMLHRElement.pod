...
Web::DOM::HTMLHRElement - The DOM |HTMLHRElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLHRElement> class implements the DOM
C<HTMLHRElement> interface.  The class is used by the HTML C<hr>
element.
