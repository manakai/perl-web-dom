...
Web::DOM::HTMLAppletElement - The DOM |HTMLAppletElement| object
...
The interface, as well as the C<applet> element, is obsolete.
...
available: C<align>, C<alt>, C<archive>, C<height>, C<hspace>,
C<name>, C<vspace>, and C<width>.  [HTML]
