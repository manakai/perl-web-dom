...
Web::DOM::HTMLDataListElement - The DOM |HTMLDataListElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLDataListElement> class implements the DOM
C<HTMLDataListElement> interface.  The class is used by the HTML
C<datalist> element.
