...
Web::DOM::HTMLProgressElement - The DOM |HTMLProgressElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLProgressElement> class implements the DOM
C<HTMLProgressElement> interface.  The class is used by the HTML
C<progress> element.
