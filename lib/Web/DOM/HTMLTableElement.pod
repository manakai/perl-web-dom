...
Web::DOM::HTMLTableElement - The DOM |HTMLTableElement| object
...
Return the table row (C<tr> element) with the specified index.  [HTML]
...
=item $boolean = $el->sortable

=item $el->sortable ($boolean)

Return or set whether the C<sortable> attribute is specified or not.
[HTML]
