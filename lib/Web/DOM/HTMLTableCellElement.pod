...
=item $tokens = $el->headers

=item $el->headers ($string)

Return the L<Web::DOM::TokenList> object for the C<headers> attribute,
or set the C<headers> attribute to the specified string value.  [HTML]
