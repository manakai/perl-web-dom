...
Web::DOM::HTMLAudioElement - The DOM |HTMLAudioElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLAudioElement> class implements the DOM
C<HTMLAudioElement> interface.  The class is used by the HTML C<audio>
element.
