...
Web::DOM::HTMLUListElement - The DOM |HTMLUListElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLUListElement> class implements the DOM
C<HTMLUListElement> interface.  The class is used by the HTML C<ul>
element.
