...
Web::DOM::HTMLMeterElement - The DOM |HTMLMeterElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLMeterElement> class implements the DOM
C<HTMLMeterElement> interface.  The class is used by the HTML C<meter>
element.
