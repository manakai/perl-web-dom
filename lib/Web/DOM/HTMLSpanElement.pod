...
Web::DOM::HTMLSpanElement - The DOM |HTMLSpanElement| object

=head1 DESCRIPTION

The C<Web::DOM::HTMLSpanElement> class implements the DOM
C<HTMLSpanElement> interface.  The class is used by the HTML C<span>
element.
