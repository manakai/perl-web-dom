...
Get or set the C<scope> attribute value.  [HTML]
...
=item $string = $el->updateviacache

=item $el->updateviacache ($string)

Get or set the C<updateviacache> attribute value.  [HTML]

=item $string = $el->workertype

=item $el->workertype ($string)

Get or set the C<workertype> attribute value.  [HTML]
