...
Return or set the C<as> attribute.  [HTML]
...
Return or set the C<integrity> attribute.  [HTML]
...
or set the C<sizes> attribute to the specified string value.  [HTML]
...
HTML Standard <https://html.spec.whatwg.org/#the-link-element>.
