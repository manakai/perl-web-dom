...
The C<Event> interface and its subinterfaces.

=item L<Web::DOM::DOMError>

The C<DOMError> interface.
...
DocumentEvent->canDispatch, DocumentType->implementation,
...
=item UIEvent, MouseEvent, KeyboardEvent, TextEvent
