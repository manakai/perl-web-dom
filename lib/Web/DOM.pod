...
DOM3 events, DocumentType->implementation,
...
the very initial phase of the development include:

=over 4

=item baseURI and related methods, as well as URL-reflecting methods [DOM] [HTML] [MANAKAI]

=item DOMStringMap [HTML]

=item DOMSettableTokenList interface [DOM] as well as tokens-reflecting methods [HTML]

=item HTMLAllCollection [HTML]

=back

Following features will be (re)implemented in due course:
